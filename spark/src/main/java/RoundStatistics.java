...
public class RoundStatistics {
  public static void main(String[] args) throws Exception{
    ...
    Dataset<Row> round = sqlConnector.query("SELECT * FROM round WHERE round_id = " + roundId).distinct();
    Dataset<Row> roundType =
        sqlConnector.query("SELECT * from ladder_type WHERE ladder_entity_id = " + roundId).distinct();
