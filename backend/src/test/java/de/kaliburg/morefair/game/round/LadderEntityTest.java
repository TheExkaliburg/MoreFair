...
public class LadderEntityTest {
    ...
    void constructor_WithRound100_ExpectingCorrectLadderTypes() {
        ...
        assertThat(new LadderEntity(1, round).getTypes()).containsExactlyInAnyOrder(LadderType.GIGANTIC, LadderType.CHEAP);
        ...
        assertThat(new LadderEntity(60, round).getTypes()).containsExactlyInAnyOrder(LadderType.GIGANTIC, LadderType.CHEAP);
