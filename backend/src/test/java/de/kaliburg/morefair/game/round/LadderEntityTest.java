...
public class LadderEntityTest {
  ...
  @Test
  void constructor_WithRound200_ExpectingCorrectLadderTypes() {
    FairConfig fairConfig = new FairConfig();
    RoundEntity round = new RoundEntity(200, fairConfig);
  ...
  @Test
  void constructor_WithRound200_Expecting10PeopleRequirementEachLadder() {
    FairConfig fairConfig = new FairConfig();
    RoundEntity round = new RoundEntity(200, fairConfig);
  ...
  @Test
  void constructor_WithRound300_ExpectingCorrectness() {
    FairConfig fairConfig = new FairConfig();
    RoundEntity round = new RoundEntity(300, fairConfig);

    assertThat(new LadderEntity(1, round).getTypes())
        .isEqualTo(EnumSet.of(LadderType.GIGANTIC, LadderType.CHEAP, LadderType.NO_AUTO,
            LadderType.ASSHOLE));
    assertThat(new LadderEntity(1, round).getBasePointsToPromote())
        .isEqualTo(BigInteger.valueOf(1_000_000_000_000_000L));

    assertThat(new LadderEntity(2, round).getTypes())
        .isEqualTo(EnumSet.of(LadderType.END));
  }

  @Test
  void constructor_WithRound301_ExpectingCorrectness() {
    FairConfig fairConfig = new FairConfig();
    RoundEntity round = new RoundEntity(301, fairConfig);
